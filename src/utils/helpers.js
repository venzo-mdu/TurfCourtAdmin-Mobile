...
export const colorCode = {
    hexCode: (Math.floor(Math.random()*16777215).toString(16) != "000000") && (Math.floor(Math.random()*16777215).toString(16).toLocaleLowerCase() != "ffffff") ? Math.floor(Math.random()*16777215).toString(16) : "880808",
};
