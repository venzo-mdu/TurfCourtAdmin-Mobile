...
const data = [
  { 
    title: 'Card 1', 
    text: 'This is card 1', 
    image: 'https://firebasestorage.googleapis.com/v0/b/venzoturfbooking.appspot.com/o/groundImages%2F6Ip56SzHQycRTqwN6nOl7iMZd193%2Fgallery3.svg?alt=media&token=47840191-00a6-4d95-b3d6-6e8cf45638fa', 
    icon: 'star', 
    points: 5 
  },
  { 
...
const CardSlider = ({ filteredGrounds, userId, onGroundsUpdated }) => {
  ...
  const [loading, setLoading] = useState(Array(filteredGrounds.length).fill(false));
